      ...
      <div className="container relative mx-auto px-4 md:px-6">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    link: null,
                    color:
                      "bg-gray-700 hover:bg-gray-800 cursor-not-allowed opacity-50",
                  },
                ].map((social, index) =>
                  social.link ? (
                    <a
                    ...
                    <div
                      key={index}
                      className={`${social.color} text-white w-12 h-12 rounded-xl flex items-center justify-center`}
        ...
        <div className="mb-20">
          ...
          <div className="glass rounded-3xl overflow-hidden">
            ...
            <div className="h-96">
              <iframe
                src="https://maps.google.com/maps?q=30.7963611,30.9958056&z=15&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
